...
const addToBasket = async (data: AddToBasketDto) => {
  return await axios.post<AddToBasketDto>(
    `${import.meta.env.VITE_API_URL}/AddToBasket`,
    data
  )
}
...
const removeFromBasket = async (data: RemoveFromBasketDto) => {
  ...
  return await axios.post<RemoveFromBasketDto>(
    `${import.meta.env.VITE_API_URL}/RemoveFromBasket/${basketId}`,
    data
  )
}
      ...
      <div className='ml-4 flex flex-1 flex-col'>
        ...
        <div className='flex flex-1 items-center justify-between text-sm gap-4'>
          ...
          <div className='flex'>
            <Button
              disabled={
                addToBasketRequest.isPending ||
                removeFromBasketRequest.isPending
              }
